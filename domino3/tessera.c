...
void drawTessera(int val1, int val2, int x, int y, bool selected){
    ...
    {
        // Render borders
        SDL_SetRenderDrawColor( game.renderer, selected?CARD_BORDER_COLOR_SELECTED:CARD_BORDER_COLOR);
