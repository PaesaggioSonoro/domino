...
```bash
cmake_modules -S. -Bbuild -DCMAKE_BUILD_TYPE=Release -DCMAKE_TOOLCHAIN_FILE=$PSPDEV/psp/share/pspdev.cmake_modules
cmake_modules --build build
cmake_modules --install build
```
